...
import 'package:rubiksolve/solve.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return ScopedModelDescendant<DataState1.DataState>(
        builder: (context, child, model) {
      return Scaffold(
          appBar: AppBar(
            title: Text("Solve Your Rubix"),
          ),
  ...
  void solveCube(_context) async {
    DataState1.DataState _dataState = ScopedModel.of(this.context);
  ...
  Future getImage(String side) async {
    ...
    final pickedFile = await picker.getImage(
        source: ImageSource.camera, maxHeight: 1600, maxWidth: 1600);
